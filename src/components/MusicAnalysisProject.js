        ...
        <div className="projectGroup">
          <div id="projectInfo" className="projectSect">
            ...
            <div className="buttons">
              <button><a href="https://app.powerbi.com/view?r=eyJrIjoiZGU0MzQ2OWYtZDYxZC00ZDlmLTlmYWItZTFiYmU5YmFiNjI2IiwidCI6IjQwYzE1OWE2LThkN2MtNDVkMS1iNWJiLTI5MDlhODc5YWEzNiJ9"><img src={PowerLogo} alt="Repo Icon"></img>Link</a></button>
            </div>
            <h2>Project Info</h2>
